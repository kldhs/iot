...
@Data
@Entity
@Table(name = ModelConstants.PERMISSION_DATA_STRATEGY_TABLE,schema = ModelConstants.SCHEMA_PERMISSION)
public class PermissionDataStrategyEntity extends BaseEntity {
